...
import { SerialMsgParser, AckMsgParser } from "./serial-msg-parser.js";
 ...
 * @param {number} [digits]
 */
export const toHexStr = (num, digits = 2) =>
  num.toString(16).padStart(digits, "0");

export const getConfig = () => {
  let config;

  try {
    config = parse(readFileSync(CFG_PATH, "utf-8"));
  } catch (e) {
    config = DEFAULT_CFG;
  }
