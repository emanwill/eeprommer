class SerialMsgFactory {
   ...
   */
  static read(address) {
    return Buffer.concat([Buffer.from([3, 0x72]), this._to15Bits(address)]);
  }
...
module.exports = { SerialMsgFactory };
